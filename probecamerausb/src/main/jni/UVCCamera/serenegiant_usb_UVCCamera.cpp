...
JNINativeMethod methods[] = {
	...
	{ "nativeSetStatusCallback",		"(JLcom/lightresearch/probecamera/ausbc/callback/IStatusCallback;)I", (void *) nativeSetStatusCallback },
	{ "nativeSetButtonCallback",		"(JLcom/lightresearch/probecamera/ausbc/callback/IButtonCallback;)I", (void *) nativeSetButtonCallback },
	...
	{ "nativeSetFrameCallback",			"(JLcom/lightresearch/probecamera/ausbc/callback/IFrameCallback;I)I", (void *) nativeSetFrameCallback },
...
int register_uvccamera(JNIEnv *env) {
	...
	if (registerNativeMethods(env,
		"com/lightresearch/probecamera/ausbc/utils/UVCCamera",
...
//	int result = register_uvccamera(env);
	jclass clazz = env->FindClass("com/lightresearch/probecamera/ausbc/utils/UVCCamera");
	if (clazz == nullptr) {
		return -1;
	}
